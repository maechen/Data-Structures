...
class BookCollection : public BookCollectionBase {
        ...
        void _remove(Book* &B, string bookName);
        Book* _findMin(Book* B);
        Book* _searchBookName(Book* B, string bookName);
        Book* _findParent(Book* B, Book* child);
        void _findPath(Book* B, string bookName, string arr[100], int& size, bool &flag);
