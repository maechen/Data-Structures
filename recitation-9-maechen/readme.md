...
```console
jovyan@jupyter-yourcuid:~$ git clone git@github.com:cu-csci-2270-spring-2023/recitation-X-MyGitUsername.git
```
...
Please refer `Recitation 9.pdf` for more details.
