...
class BookCollection {
    private:
        Book* root;
        void _destructor(Book* B);
        void _addBook(Book *&B, string bookName, string author, double rating);
        void _inOrder(Book *B);
        Book* _searchBookName(Book *B, string bookName);
        void _searchAuthor(Book *B, string author);
        Book* _highest(Book *B);
        void _searchRating(Book *B, double rating);
        int _height(Book *B);
